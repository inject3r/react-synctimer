 ...
 */
declare const timers: Map<number, TimerInfo>;
/**
 ...
 * }, 1000, true);
 */
export declare function SetTimer(callback: () => void, interval: number, repeating?: boolean): number;
/**
 ...
 * );
 */
export declare function SetTimerEx<T extends any[]>(callback: (...args: T) => void, interval: number, repeating?: boolean, ...args: T): number;
/**
 ...
 */
export declare function KillTimer(timerId: number): number;
/**
 ...
 */
export declare function IsRepeatingTimer(timerId: number): boolean;
/**
 ...
 */
export declare function CountRunningTimers(): number;
/**
 ...
 */
export declare function CountRunningExTimers(): number;
/**
 ...
 */
export declare function PauseTimer(timerId: number): boolean;
/**
 ...
 */
export declare function ResumeTimer(timerId: number): boolean;
/**
 ...
 */
export declare function useTimer(callback: () => void, interval: number, repeating?: boolean): void;
/**
 ...
 */
export declare function useTimerEx<T extends any[]>(callback: (...args: T) => void, interval: number, repeating?: boolean, ...args: T): void;
export { timers };
