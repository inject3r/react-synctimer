...
exports.SetTimerEx = SetTimerEx;
exports.KillTimer = KillTimer;
exports.IsValidTimer = IsValidTimer;
exports.IsRepeatingTimer = IsRepeatingTimer;
exports.CountRunningTimers = CountRunningTimers;
exports.CountRunningExTimers = CountRunningExTimers;
exports.PauseTimer = PauseTimer;
exports.ResumeTimer = ResumeTimer;
exports.useTimer = useTimer;
exports.useTimerEx = useTimerEx;
 ...
 * }, 1000, true);
 */
function SetTimer(callback, interval, repeating = false) {
 ...
 * );
 */
function SetTimerEx(callback, interval, repeating = false, ...args) {
    const id = timerCounter++;
 ...
 */
function IsRepeatingTimer(timerId) {
    const timer = timers.get(timerId);
 ...
 */
function useTimer(callback, interval, repeating = false) {
 ...
 */
function useTimerEx(callback, interval, repeating = false, ...args) {
    const callbackRef = (0, react_1.useRef)(callback);
    callbackRef.current = callback;
    (0, react_1.useEffect)(() => {
        const id = SetTimerEx((...params) => callbackRef.current(...params), interval, repeating, ...args);
        return () => {
            KillTimer(id);
        };
